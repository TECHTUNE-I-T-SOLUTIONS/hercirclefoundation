      ...
      <main className="flex-1">
        ...
        <section className="py-16 md:py-24 bg-gradient-to-br from-primary/10 to-transparent">
          <div className="container mx-auto px-4">
            <h1 className="text-4xl md:text-5xl font-bold mb-4">About Her Circle Foundation</h1>
        ...
        <section className="py-16 md:py-24">
          <div className="container mx-auto px-4 max-w-3xl">
            ...
            <div className="space-y-6 text-lg text-muted-foreground leading-relaxed">
              <p>
                Her Circle Foundation was born from a simple yet powerful realization: millions of girls and young women
              ...
              <p>
                Today, Her Circle Foundation stands as a beacon of hope, providing free sanitary pads, comprehensive
                ...
                <CardContent className="pt-6">
                  <div className="text-center">
                    ...
                    <p className="text-sm leading-relaxed">
                      With a passion for women's health and social justice, Sanni founded Her Circle Foundation to
